...
<div class="header">
    <br>
 <h4 class="card-title">Mostrar Usuarios</h4>
 <br>
...
<!--<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="usuario" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
 ...
 <select name="roll"  class="form-control border-input" required="true"  name="tipo_event" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="apellido_p" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="apellido_m" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="nombre" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="direccion" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="colonia" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="number" name="telefono" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="number" name="celular" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="text" name="lugar_nacimiento" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-3">
       ...
       <input type="date" name="fecha_nac" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
<!--fin div Actividades-->
