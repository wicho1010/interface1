...
VALUES ('$var_usuario' , '$var_contraseña', '1' , '$var_apellidop' , '$var_apellidom' ,'$var_nombre','$var_direccion','$var_colonia','$var_cp','$var_telefono','$var_celular','$var_lugar_nacimiento','$var_fecha_nac','$var_opsexo')";
